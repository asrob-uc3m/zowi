//Zowi Maker Faire Robot-Remote control
...
#define TRIM_RR -25    //Leg Roll Right
#define TRIM_RL -10     //Leg Roll Left
#define TRIM_YR 0     //Leg Yaw Right
#define TRIM_YL -10     //Leg Yaw Left
#define TRIM_SR 35//62      //Shoulder Right
#define TRIM_SL -78 //-72      //Shoulder Left
#define TRIM_AR -80//-38     //Arm Right
#define TRIM_AL 45//45    //Arm Left
#define TRIM_H -15//-15      //Head
...
void forward(unsigned char steps, short T){
    signed char A[9]= {20, 20, 25, 25, 45, 30, 55, 25, 25};
    signed char O[9] = { -2, -1, 0, 0, -60, 60, -20, 20, 0};//-- anda con el interior
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(0), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(270), DEG2RAD(270), DEG2RAD(0), DEG2RAD(0),DEG2RAD(0)};

    for(unsigned char i=0;i<steps;i++) oscillate(A,O, T, phase_diff);
}

void turnLfwd(unsigned char steps, short T){
    signed char A[9]= {20, 20, 10, 30, 45, 30, 55, 25,0};
    signed char O[9] = {-2, -1, 0, 0, -60, 60, -20, 20,30};
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(0), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(270), DEG2RAD(270), DEG2RAD(0), DEG2RAD(0), DEG2RAD(0)};
...
void turnLbwd(unsigned char steps, short T){
    signed char A[9]= {20, 20, 10, 30, 30, 30, 25, 25, 0};
    signed char O[9] = {-2, -1, 0, 0, -100, 100, -20, 20, 0};
    float phase_diff[9] = {DEG2RAD(180), DEG2RAD(180), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(270), DEG2RAD(270), DEG2RAD(180), DEG2RAD(180),DEG2RAD(0)};

    for(unsigned char i=0;i<steps;i++) oscillate(A,O, T, phase_diff);
}

void turnRfwd(unsigned char steps, short T){
    signed char A[9]= {20, 20, 30, 10, 45, 30, 55, 25, 0};
    signed char O[9] = {-2, -1, 0, 0, -60, 60, -20, 20, -30};
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(0), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(270), DEG2RAD(270), DEG2RAD(0), DEG2RAD(0), DEG2RAD(0)};
...
void turnRbwd(unsigned char steps, short T){
    signed char A[9]= {20, 20, 30, 10, 30, 30, 25, 25, 0};
    signed char O[9] = {-2, -1, 0, 0, -100, 100, -20, 20, 0};
    float phase_diff[9] = {DEG2RAD(180), DEG2RAD(180), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(270), DEG2RAD(270), DEG2RAD(180), DEG2RAD(180),DEG2RAD(0)};
...
void backward(unsigned char steps, short T){
    signed char A[9]= {20, 20, 25, 25, 45, 30, 55, 25,0};
    signed char O[9] = {-2, -1, 0, 0, -100, 100, -20, 20,0};
    float phase_diff[9] = {DEG2RAD(180), DEG2RAD(180), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(270), DEG2RAD(270), DEG2RAD(180), DEG2RAD(180),DEG2RAD(0)};
...
void slideR(unsigned char steps, short T){
    signed char A[9]= {40, 40, 0, 0, 0, 0, 15, 15, 0};
    signed char O[9] = {-15, 15, 0, 0, -80, 80, -30, 30, 0}; //50/110
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(180 + 120), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(180), DEG2RAD(180), DEG2RAD(90), DEG2RAD(90), DEG2RAD(0)}; //270/180
...
void slideL(unsigned char steps, short T){
    ...
    signed char O[9] = {-15, 15, 0, 0, -80, 80, -30, 30, 0};//50/110
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(180 - 120), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(0), DEG2RAD(0), DEG2RAD(90), DEG2RAD(90), DEG2RAD(0)};//90/180
...
void moonWalkR(unsigned char steps, short T){
    signed char A[9]= {25, 25, 0, 0, 0, 0, 20, 20,0};
    signed char O[9] = {-15, 15, 0, 0, -80, 80, 50, -50,0}; //50/110
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(180 + 120), DEG2RAD(90), DEG2RAD(90),
                            DEG2RAD(180), DEG2RAD(180), DEG2RAD(90), DEG2RAD(90),DEG2RAD(0)}; //270/180
...
void upDown(unsigned char steps, short T){
    signed char A[9]= {25, 25, 0, 0, 0, 0, 35, 35,0};
    signed char O[9] = {-25, 25, 0, 0, -60, 60, 0, 0,0};
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(180), 0, 0,
                            0, 0, DEG2RAD(0), DEG2RAD(180),0};
...
void lookaround(unsigned char steps, short T){
    signed char A[9]= {0, 0, 0, 0, 0, 0, 0, 0, 45};
    signed char O[9] = {0, 0, 0, 0, 170, 80, 130, 90,0}; //50/110
    float phase_diff[9] = {DEG2RAD(0), DEG2RAD(180), DEG2RAD(0), DEG2RAD(0),
                            DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), DEG2RAD(0),DEG2RAD(0)}; //270/180
