...
//-- is connected
void Oscillator::attach(short pin, bool rev)
{
...
/*************************************/
void Oscillator::SetT(unsigned short T)
{
...
void Oscillator::SetPosition(short position)
{
...
void Oscillator::refresh()
{
  ...
  if (next_sample()) {
      ...
      if (!_stop) {
        ...
        _pos = round(((unsigned short) _A) * sin(_phase + _phase0) + ((unsigned short) _O));
	if (_rev) _pos=-_pos;
